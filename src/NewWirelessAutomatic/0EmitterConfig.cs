...
namespace NewWirelessAutomatic
{
    ...
    using static NWA_CONST.Emitter;
    public class EmitterConfig : IBuildingConfig
    {
        ...
        public override void DoPostConfigureComplete(GameObject go)
        {
            ...
            go.AddOrGet<SignalEmitter>().EmitChannel = DEF_CHANNEL;
            go.AddOrGet<LogicOperationalController>().unNetworkedValue = 0;
        }

        private void Func(GameObject go) => GeneratedBuildings.RegisterLogicPorts(go, INPUT);
    }
}
